...
use defuse_tep104::SignedTep104Payload;
...
impl Payload for MultiPayload {
    ...
    fn hash(&self) -> CryptoHash {
        match self {
            ...
            Self::Tep104(payload) => payload.hash(),
        }
    }
}
...
impl SignedPayload for MultiPayload {
    ...
    fn verify(&self) -> Option<Self::PublicKey> {
        match self {
            ...
            Self::Tep104(payload) => payload.verify().map(PublicKey::Ed25519),
        }
    }
}
    ...
    T: DeserializeOwned,
{
    ...
    fn extract_defuse_payload(self) -> Result<DefusePayload<T>, Self::Error> {
        match self {
            ...
            Self::Tep104(payload) => payload.extract_defuse_payload(),
        }
    }
}
