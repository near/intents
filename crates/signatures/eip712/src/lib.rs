...
pub const WALLET_MESSAGE_TYPE: &str = "WalletMessage(string chainId,string signerId,uint32 nonce,string createdAt,uint32 timeoutSecs,string ops,string out)";

/// Pre-computed domain separator.
/// See [`test_domain_separator`] for the derivation.
const DOMAIN_SEPARATOR: CryptoHash = [
    0x9e, 0xd0, 0x38, 0x4a, 0x93, 0x69, 0xf4, 0x2a, 0xa8, 0x9e, 0x17, 0x2b, 0x67, 0x35, 0x9e, 0x73,
    0x23, 0x8f, 0xce, 0x30, 0x3b, 0x45, 0xb9, 0x28, 0x42, 0xe4, 0x71, 0x87, 0x4e, 0x2f, 0x6d, 0x22,
];
...
const WALLET_MESSAGE_TYPEHASH: CryptoHash = [
    0x58, 0xbf, 0x0b, 0x90, 0xf2, 0x8e, 0xcd, 0x57, 0xe8, 0x5c, 0x83, 0x0e, 0x6e, 0x40, 0x7f, 0x9b,
    0xbf, 0x49, 0x3c, 0x27, 0xf8, 0x16, 0x44, 0x23, 0x98, 0xce, 0xfe, 0x24, 0xc1, 0x86, 0x5e, 0xc5,
];
