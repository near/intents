...
use defuse_near_utils::{UnwrapOrPanic, UnwrapOrPanicError, max_list_u128_json_len};
...
impl MultiTokenWithdrawResolver for Contract {
    ...
    fn mt_resolve_withdraw(
        ...
        let mut used = env::promise_result_checked(0, max_list_u128_json_len(amounts.len()))
            .map_or_else(
                |_err| {
                    if is_call {
